...
### **3. [TLS 1.2 Handshake](#tls-12-handshake)**
...
### **5. [Tấn công Padding Oracle](#tan-cong-padding-oracle)**
- Cách hoạt động của tấn công Padding Oracle.
- Tác động và cách phòng chống.

### **6. [POODLE & BEAST](#poodle-va-beast)**
...
### **10. [Heartbleed Bug](#heartbleed-bug)**
- Lỗ hổng Heartbleed trong OpenSSL.
- Hậu quả và các bước khắc phục.

### **11. [SSL Stripping và Cách Phòng Chống](#ssl-stripping-va-cach-phong-chong)**
- Phương thức tấn công SSL Stripping.
- Cách triển khai HSTS (HTTP Strict Transport Security) để phòng chống.

### **12. [Các Cuộc Tấn Công Mã Hóa (Cryptographic Attacks)](#cac-cuoc-tan-cong-ma-hoa)**
