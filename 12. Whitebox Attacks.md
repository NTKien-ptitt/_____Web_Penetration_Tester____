# MỤC LỤC
## 1. **Tấn công Whitebox và Prototype Pollution**
- [Giới thiệu về tấn công Whitebox](#1-giới-thiệu-về-tấn-công-whitebox)
- [Đối tượng & nguyên mẫu JavaScript](#2-đối-tượng-nguyên-mẫu-javascript)
- [Giới Thiệu về Prototype Pollution](#3-giới-thiệu-về-prototype-pollution)
- [Tăng cường đặc quyền thông qua ô nhiễm nguyên mẫu](#4-tăng-cường-đặc-quyền-thông-qua-ô-nhiễm-nguyên-mẫu)
- [Phân tích và khai thác lỗi **Prototype Pollution** trong ứng dụng web](#5-phân-tích-và-khai-thác-lỗi-prototype-pollution-trong-ứng-dụng-web)

## 2. **Code Review và Phòng ngừa**
- [Code Review - Xác định Lỗ Hổng](#6-code-review-xác-định-lỗ-hổng)
- [Exploitation Remarks & Prevention (Nhận Định Về Việc Khai Thác và Phòng Ngừa)](#7-exploitation-remarks-prevention-nhận-định-về-việc-khai-thác-và-phòng-ngừa)

## 3. **Điều kiện Cuộc đua và Tấn công Thời gian**
- [Giới thiệu về Điều kiện Cuộc đua và Tấn công Thời gian](#8-giới-thiệu-về-điều-kiện-cuộc-đua-và-tấn-công-thời-gian)
- [Đếm người dùng qua thời gian phản hồi](#9-đếm-người-dùng-qua-thời-gian-phản-hồi)
- [Lộ lọt dữ liệu qua thời gian phản hồi](#10-lộ-lọt-dữ-liệu-qua-thời-gian-phản-hồi)
- [Race Conditions trong Ứng dụng Web](#11-race-conditions-trong-ứng-dụng-web)

## 4. **Type Juggling và Lỗ hổng trong PHP**
- [Giới thiệu về Type Juggling (Biến đổi kiểu)](#12-giới-thiệu-về-type-juggling-biến-đổi-kiểu)
- [Bỏ qua xác thực với Type Juggling trong PHP](#13-bỏ-qua-xác-thực-với-type-juggling-trong-php)
- [Phân tích và Khai thác Lỗ hổng Command Injection qua Type Juggling](#14-phân-tích-và-khai-thác-lỗ-hổng-command-injection-qua-type-juggling)
